package com.bank.mooc.shared.infrastructure.database

import com.bank.mooc.account.application.{ AccountSearchable, AccountUpdatable }
import com.bank.mooc.account.domain.{ Account, AccountId }
